...
title: Testimonies of Caste in the USA
description: First-person accounts documenting caste discrimination, exclusion, and casteist practices in the United States.
eyebrow: Community testimonies
intro: These first-person accounts document casteist practices at school, at work, in neighborhoods, at social gatherings, and in family life.
contentNote: The testimonies retain the wording of the original submissions. Pseudonyms are used to protect respondents’ anonymity.
categories:
  - label: Misrepresentation of Indian culture
    id: misrepresentation-of-indian-culture-as-a-result-of-savarna-dominance
  - label: Segregation and exclusion
    id: segregation-and-exclusion-because-of-caste-identity
  - label: Caste and food choices
    id: enforcing-reinforcing-caste-through-food-choices
  - label: Political ideology
    id: casteism-as-a-political-ideology
  - label: Hostility to affirmative action
    id: open-expression-of-hostility-to-affirmative-action-andor-dalit-bahujan-identity
  - label: School and work
    id: entitled-and-discriminatory-behavior-by-members-of-so-called-upper-castes-at-schoolwork-etc
  - label: Caste-based favoritism
    id: caste-based-favoritism
  - label: Caste-sleuthing
    id: sleuthing-about-caste-identity-caste-sleuthing-through-questions-about-food-habits
  - label: Children and casteism
    id: children--casteism
  - label: Caste pride
    id: claiming-advertising-and-expressing-pride-in-ones-caste-identity
  - label: Community organizations
    id: caste-in-community-and-cultural-organizations
  - label: Culture and Sanskrit
    id: ancient-pride-culture--sanskrit-and-casteism
  - label: Workplace nepotism
...
This is a first set of testimonies and more are to be published. We will publish in multiple rounds owing to resources required to edit and format the testimonies. To protect the anonymity of our respondees, we are using pseudonyms in the statements below.

## Misrepresentation of Indian culture as a result of Savarna dominance

### Overrepresentation of Upper Caste Hindus in the Tech sector
...
— _Sripriya Ramanujam, New York, NY_
...
— _B Jayakumar, Cupertino, CA._

## Enforcing/ Reinforcing caste through Food choices

### 7 Years Old Girl Made to Cry for Eating Pepperoni Pizza.

I live in a town in Massachusetts where there is a large Indian community. My daughter Pavithra is a second grader at a local school and had the following experience one day during lunch:

That day’s school lunch consisted of two kinds of pizzas, specifically cheese pizzas and pepperoni pizzas. Pavithra took a pepperoni pizza and went to her lunch table to eat with her friends, some of whom are kids from Indian families. When one or some of her friends expressed surprise to see an Indian kid eating pepperoni pizza, Pavithra told them that she loves pepperoni pizza and continued eating. Another kid then said “we Indians don’t eat cow and pig meat and we worship cows”. Pavithra was upset but did not know how to react but quietly finished her lunch (eating most of the pizza); she was however confused about whether she had done anything wrong as a kid of Indian origin.

That evening, she came home and was almost crying when she explained the lunch-time situation. It gave us an opportunity to talk to her about India, the different religious beliefs and cultural differences within India, and she eventually understood that she had not done anything wrong, but that her friends needed some learning.

We later talked with the school teacher about the issue, and she was sorry and talked to the students and took care of this.

— _Ramakrishna, Massachusetts._
...
— _Geetha Balamurugan, Santa Clara, CA._
...
— _K Balasubramani, Mountain View, CA._
...
— _Chidambaram A, San Francisco, CA_
...
— _Rajeshkannah V, Pleasanton, CA_
...
— _Sornam Sankarapandi, Ellicott City, Maryland._
...
— _Prasana Jaitale, Mountain House, CA_
